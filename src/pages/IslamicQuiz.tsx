...
const IslamicQuiz: React.FC = () => {
  ...
  const handleAnswerSubmit = () => {
    ...
    const isCorrect = answerIndex === currentQuestion.answer; // Changed from correctAnswer
    ...
    if (currentQuestionIndex + 1 >= dailyQuestions.length) { // Changed from currentQuestions.length
  ...
  const getScoreMessage = () => {
    const percentage = (score / dailyQuestions.length) * 100; // Changed from currentQuestions.length
    if (percentage >= 80) {
