...
const resources = {
  ...
  fr: {
    translation: {
      ...
      // Hisnul Muslim
      'hisnulMuslim.introduction': 'Introduction',
      'hisnulMuslim.virtuesOfDhikr': 'Vertus du Dhikr',
      'hisnulMuslim.wakingUpDhikr': 'Dhikr du Réveil',
      'hisnulMuslim.wearingClothesDua': 'Dua pour Porter des Vêtements',
      'hisnulMuslim.newClothesDua': 'Dua pour Porter de Nouveaux Vêtements',
      'hisnulMuslim.duaForSomeoneWearingNewClothes': 'Dua pour Celui qui Porte de Nouveaux Vêtements',
      'hisnulMuslim.whatToSayWhenUndressing': 'Que Dire en se Déshabillant',
      'hisnulMuslim.enteringToiletDua': 'Dua pour Entrer aux Toilettes',
      'hisnulMuslim.leavingToiletDua': 'Dua pour Sortir des Toilettes',
      'hisnulMuslim.beforeWuduDhikr': 'Dhikr Avant les Ablutions',
      'hisnulMuslim.afterWuduDhikr': 'Dhikr Après les Ablutions',
      'hisnulMuslim.leavingHomeDhikr': 'Dhikr en Quittant la Maison',
      'hisnulMuslim.enteringHomeDhikr': 'Dhikr en Entrant à la Maison',
      'hisnulMuslim.goingToMosqueDua': 'Dua pour Aller à la Mosquée',
      'hisnulMuslim.enteringMosqueDua': 'Dua pour Entrer à la Mosquée',
      'hisnulMuslim.leavingMosqueDua': 'Dua pour Sortir de la Mosquée',
      'hisnulMuslim.adhanDhikr': 'Dhikr de l\'Adhan',
      'hisnulMuslim.openingDua': 'Dua d\'Ouverture',
      'hisnulMuslim.rukuDua': 'Dua du Ruku',
      'hisnulMuslim.afterRukuDua': 'Dua Après le Ruku',
      'hisnulMuslim.sujoodDua': 'Dua du Sujood',
      'hisnulMuslim.sittingBetweenSujoodDua': 'Dua Entre Deux Sujoods',
      'hisnulMuslim.sujoodTilawaDua': 'Dua pour le Sujood de la Tilawa',
      'hisnulMuslim.tashahhud': 'Tachahoud',
      'hisnulMuslim.salatOnProphetAfterTashahhud': 'Prière sur le Prophète Après le Tachahoud',
      'hisnulMuslim.duaAfterTashahhud': 'Dua Après le Dernier Tachahoud',
      'hisnulMuslim.afterSalahDhikr': 'Dhikr Après la Prière',
      'hisnulMuslim.istikharaDua': 'Dua de l\'Istikhara',
      'hisnulMuslim.morningEveningDhikr': 'Dhikr du Matin et du Soir',
      'hisnulMuslim.sleepingDhikr': 'Dhikr du Sommeil',
      'hisnulMuslim.duaWhenTossingAtNight': 'Dua en se Tournant la Nuit',
      'hisnulMuslim.duaForAnxietyAndFearDuringSleep': 'Dua pour l\'Anxiété et la Peur Pendant le Sommeil',
      'hisnulMuslim.whatToDoWhenSeeingADream': 'Que Faire en Voyant un Rêve',
      'hisnulMuslim.qunootAlWitrDua': 'Dua du Qunoot Al-Witr',
      'hisnulMuslim.dhikrAfterWitrSalam': 'Dhikr Après le Salam du Witr',
      'hisnulMuslim.duaForWorryAndGrief': 'Dua pour l\'Inquiétude et le Chagrin',
      'hisnulMuslim.duaForDistress': 'Dua pour la Détresse',
      'hisnulMuslim.duaForMeetingEnemyAndRuler': 'Dua pour Rencontrer l\'Ennemi et le Dirigeant',
      'hisnulMuslim.duaForFearOfRulerOppression': 'Dua pour la Peur de l\'Oppression du Dirigeant',
      'hisnulMuslim.duaAgainstEnemy': 'Dua Contre l\'Ennemi',
      'hisnulMuslim.whatToSayWhenFearingAGroupOfPeople': 'Que Dire en Craignant des Gens',
      'hisnulMuslim.duaForDoubtInFaith': 'Dua pour le Doute dans la Foi',
      'hisnulMuslim.duaForPayingOffDebt': 'Dua pour Rembourser les Dettes',
      'hisnulMuslim.duaForWaswasaInPrayerAndReading': 'Dua pour le Waswasa dans la Prière et la Lecture',
      'hisnulMuslim.duaForDifficulty': 'Dua pour la Difficulté',
      'hisnulMuslim.whatToSayAndDoWhenSinning': 'Que Dire et Faire en Péchant',
      'hisnulMuslim.duaForExpellingShaytanAndHisWhispers': 'Dua pour Expulser Shaytan et Ses Murmures',
      'hisnulMuslim.duaWhenSomethingDislikedHappens': 'Dua Quand Quelque Chose de Déplaisant Arrive',
      'hisnulMuslim.congratulatingNewParent': 'Féliciter un Nouveau Parent',
      'hisnulMuslim.seekingProtectionForChildren': 'Chercher Protection pour les Enfants',
      'hisnulMuslim.duaForVisitingTheSick': 'Dua pour Visiter le Malade',
      'hisnulMuslim.virtueOfVisitingTheSick': 'Vertu de Visiter le Malade',
      'hisnulMuslim.duaOfAPatientWhoHasGivenUpHope': 'Dua d\'un Patient Ayant Perdu Espoir',
      'hisnulMuslim.talqeenForTheDying': 'Talqeen pour le Mourant',
      'hisnulMuslim.duaForCalamity': 'Dua pour la Calamité',
      'hisnulMuslim.duaWhenClosingTheEyesOfTheDeceased': 'Dua en Fermant les Yeux du Défunt',
      'hisnulMuslim.duaForTheDeceasedInFuneralPrayer': 'Dua pour le Défunt dans la Prière Funéraire',
      'hisnulMuslim.duaForPretermChildInFuneralPrayer': 'Dua pour l\'Enfant Prématuré dans la Prière Funéraire',
      'hisnulMuslim.duaForCondolence': 'Dua de Condoléances',
      'hisnulMuslim.duaWhenPlacingTheDeceasedInTheGrave': 'Dua en Plaçant le Défunt dans la Tombe',
      'hisnulMuslim.duaAfterBuryingTheDeceased': 'Dua Après l\'Enterrement du Défunt',
      'hisnulMuslim.duaForVisitingGraves': 'Dua pour Visiter les Tombes',
      'hisnulMuslim.duaForWind': 'Dua pour le Vent',
      'hisnulMuslim.duaForThunder': 'Dua pour le Tonnerre',
      'hisnulMuslim.duaForSeekingRain': 'Dua pour Demander la Pluie',
      'hisnulMuslim.duaWhenItRains': 'Dua Quand il Pleut',
      'hisnulMuslim.dhikrAfterRain': 'Dhikr Après la Pluie',
      'hisnulMuslim.duaForSeekingClearWeather': 'Dua pour Demander un Temps Clair',
      'hisnulMuslim.duaForSightingTheNewMoon': 'Dua pour Voir la Nouvelle Lune',
      'hisnulMuslim.duaWhenBreakingTheFast': 'Dua en Rompant le Jeûne',
      'hisnulMuslim.duaBeforeEating': 'Dua Avant de Manger',
      'hisnulMuslim.duaAfterEating': 'Dua Après Manger',
      'hisnulMuslim.guestDuaForTheHost': 'Dua de l\'Invité pour l\'Hôte',
      'hisnulMuslim.duaForSomeoneWhoGivesADrink': 'Dua pour Celui qui Donne à Boire',
      'hisnulMuslim.duaWhenBreakingFastAtSomeoneHouse': 'Dua en Rompant le Jeûne Chez Quelqu\'un',
      'hisnulMuslim.duaOfAFastingPersonWhenFoodIsPresentAndHeIsNotBreakingHisFast': 'Dua d\'un Jeûneur en Présence de Nourriture Sans Rompre le Jeûne',
      'hisnulMuslim.whatAFastingPersonSaysWhenInsulted': 'Ce que Dit un Jeûneur Insulté',
      'hisnulMuslim.duaUponSeeingTheFirstFruit': 'Dua en Voyant le Premier Fruit',
      'hisnulMuslim.duaForSneezing': 'Dua pour l\'Éternuement',
      'hisnulMuslim.whatToSayToANonMuslimWhoSneezesAndPraisesAllah': 'Que Dire à un Non-Musulman qui Éternue et Loue Allah',
      'hisnulMuslim.duaForANewlyMarriedPerson': 'Dua pour un Nouveau Marié',
      'hisnulMuslim.duaForAMarriedPersonForHimselfAndWhenBuyingAnAnimal': 'Dua d\'un Marié pour Lui-même et en Achetant un Animal',
      'hisnulMuslim.duaBeforeIntercourse': 'Dua Avant les Rapports Conjugaux',
      'hisnulMuslim.duaForAnger': 'Dua pour la Colère',
      'hisnulMuslim.duaForSeeingSomeoneInTrial': 'Dua pour Voir Quelqu\'un en Épreuve',
      'hisnulMuslim.whatToSayInAGathering': 'Que Dire en Réunion',
      'hisnulMuslim.expiationOfAGathering': 'Expiation d\'une Réunion',
      'hisnulMuslim.duaForSomeoneWhoSaysGhafarAllahuLak': 'Dua pour Celui qui Dit Ghafar Allahu Lak',
      'hisnulMuslim.duaForSomeoneWhoDoesAFavor': 'Dua pour Celui qui Rend un Service',
      'hisnulMuslim.whatProtectsFromTheDajjal': 'Ce qui Protège du Dajjal',
      'hisnulMuslim.duaForSomeoneWhoSaysILoveYouForTheSakeOfAllah': 'Dua pour Celui qui Dit Je t\'Aime pour l\'Amour d\'Allah',
      'hisnulMuslim.duaForSomeoneWhoOffersYouHisWealth': 'Dua pour Celui qui t\'Offre Sa Richesse',
      'hisnulMuslim.duaForSomeoneWhoLendsYouMoney': 'Dua pour Celui qui te Prête de l\'Argent',
      'hisnulMuslim.duaForFearOfShirk': 'Dua pour la Peur du Shirk',
      'hisnulMuslim.duaForSomeoneWhoSaysBarakAllahuFeek': 'Dua pour Celui qui Dit Barak Allahu Feek',
      'hisnulMuslim.duaForDislikingOmens': 'Dua pour Aimer les Bons Présages',
      'hisnulMuslim.duaForRidingAnAnimal': 'Dua pour Monter un Animal',
      'hisnulMuslim.duaForTraveling': 'Dua pour le Voyage',
      'hisnulMuslim.duaForEnteringAVillageOrTown': 'Dua pour Entrer dans un Village ou une Ville',
      'hisnulMuslim.duaForEnteringTheMarket': 'Dua pour Entrer au Marché',
      'hisnulMuslim.duaIfTheRideFalters': 'Dua si la Monture Trébuche',
      'hisnulMuslim.travelersDuaForTheResident': 'Dua du Voyageur pour le Résident',
      'hisnulMuslim.residentsDuaForTheTraveler': 'Dua du Résident pour le Voyageur',
      'hisnulMuslim.takbeerAndTasbeehDuringTravel': 'Takbir et Tasbih Pendant le Voyage',
      'hisnulMuslim.travelersDuaAtDawn': 'Dua du Voyageur à l\'Aube',
      'hisnulMuslim.duaWhenStoppingAtAPlaceDuringTravelOrOtherwise': 'Dua en s\'Arrêtant en Voyage ou Autrement',
      'hisnulMuslim.dhikrWhenReturningFromTravel': 'Dhikr en Revenant de Voyage',
      'hisnulMuslim.whatToSayAndDoWhenSomethingPleasingOrDispleasingHappens': 'Que Dire et Faire Quand Quelque Chose d\'Agréable ou de Déplaisant Arrive',
      'hisnulMuslim.virtueOfSendingPrayersUponTheProphet': 'Vertu d\'Envoyer des Prières sur le Prophète',
      'hisnulMuslim.spreadingSalam': 'Propager le Salam',
      'hisnulMuslim.howToReturnSalamToANonMuslim': 'Comment Rendre le Salam à un Non-Musulman',
      'hisnulMuslim.duaForTheCrowingOfARoosterAndTheBrayingOfADonkey': 'Dua pour le Chant du Coq et le Braiment de l\'Âne',
      'hisnulMuslim.duaForTheBarkingOfDogsAtNight': 'Dua pour l\'Aboiement des Chiens la Nuit',
      'hisnulMuslim.duaForSomeoneYouHaveCursed': 'Dua pour Celui que Tu as Maudit',
      'hisnulMuslim.whatAMuslimSaysWhenPraisingAnotherMuslim': 'Ce que Dit un Musulman en Louant un Autre Musulman',
      'hisnulMuslim.whatAMuslimSaysWhenHeIsPraised': 'Ce que Dit un Musulman Loué',
      'hisnulMuslim.howAMuhrimSaysTheTalbiyahInHajjOrUmrah': 'Comment un Muhrim Dit la Talbiyah au Hajj ou à la Omra',
      'hisnulMuslim.takbeerWhenComingToTheBlackStone': 'Takbir en Arrivant à la Pierre Noire',
      'hisnulMuslim.duaBetweenTheYemeniCornerAndTheBlackStone': 'Dua Entre le Coin Yéménite et la Pierre Noire',
      'hisnulMuslim.duaAtSafaAndMarwa': 'Dua à Safa et Marwa',
      'hisnulMuslim.duaOnTheDayOfArafah': 'Dua le Jour de Arafat',
      'hisnulMuslim.dhikrAtAlMasharAlHaram': 'Dhikr à Al-Mashar Al-Haram',
      'hisnulMuslim.takbeerWhenThrowingThePebblesAtTheJamarat': 'Takbir en Jetant les Cailloux aux Jamarat',
      'hisnulMuslim.whatToSayWhenAmazedOrPleased': 'Que Dire en Cas d\'Étonnement ou de Plaisir',
      'hisnulMuslim.whatToDoWhenSomethingPleasingHappens': 'Que Faire Quand Quelque Chose d\'Agréable Arrive',
      'hisnulMuslim.whatToSayWhenFeelingPainInTheBody': 'Que Dire en Ressentant une Douleur dans le Corps',
      'hisnulMuslim.duaForFearOfTheEvilEye': 'Dua pour la Peur du Mauvais Œil',
      'hisnulMuslim.whatToSayWhenStartled': 'Que Dire en Cas de Peur',
      'hisnulMuslim.whatToSayWhenSlaughteringOrSacrificing': 'Que Dire en Abattant ou Sacrifiant',
      'hisnulMuslim.whatToSayToRepelTheEvilOfTheDevils': 'Que Dire pour Repousser le Mal des Diables',
      'hisnulMuslim.seekingForgivenessAndRepentance': 'Chercher Pardon et Repentir',
      'hisnulMuslim.virtueOfTasbeehTahmeedTahleelAndTakbeer': 'Vertu du Tasbih, Tahmid, Tahlil et Takbir',
      'hisnulMuslim.howTheProphetUsedToDoTasbeeh': 'Comment le Prophète Faisait le Tasbih',
      'hisnulMuslim.typesOfGoodnessAndComprehensiveManners': 'Types de Bienfaits et Manières Complètes',
    }
  }
}
