...
QUIZ_DATA = [
    ...
    {
        "id": 11,
        "question": "أنا صحابي جليل، لُقبت بـ\'سيف الله المسلول\'، وكنت قائداً عظيماً في الفتوحات الإسلامية. فمن أنا؟",
        "answer": "خالد بن الوليد",
        "explanation": "خالد بن الوليد رضي الله عنه كان قائداً عسكرياً فذاً، لُقب بسيف الله المسلول لشجاعته وبراعته في المعارك.",
        "difficulty": "متوسط"
    },
    {
        "id": 12,
        "question": "أنا عبادة إسلامية، تُؤدى في شهر معين، وهي ركن من أركان الإسلام، وفيها يمتنع المسلم عن الطعام والشراب من الفجر حتى المغرب. فما أنا؟",
        "answer": "الصيام",
        "explanation": "الصيام هو ركن من أركان الإسلام، ويُؤدى في شهر رمضان المبارك، وهو الامتناع عن المفطرات من الفجر إلى المغرب.",
        "difficulty": "سهل"
    },
    {
        "id": 13,
        "question": "أنا كتاب إسلامي، يُعد ثاني مصدر للتشريع بعد القرآن الكريم، ويحتوي على أقوال وأفعال وتقريرات النبي محمد صلى الله عليه وسلم. فما أنا؟",
        "answer": "السنة النبوية",
        "explanation": "السنة النبوية هي كل ما ورد عن النبي محمد صلى الله عليه وسلم من قول أو فعل أو تقرير، وهي المصدر الثاني للتشريع الإسلامي.",
        "difficulty": "متوسط"
    },
    {
        "id": 14,
        "question": "أنا مدينة مقدسة في الإسلام، فيها المسجد الأقصى، وهي أولى القبلتين وثالث الحرمين الشريفين. فما أنا؟",
        "answer": "القدس",
        "explanation": "القدس هي مدينة مقدسة في الإسلام، فيها المسجد الأقصى، وهي أولى القبلتين وثالث الحرمين الشريفين.",
        "difficulty": "سهل"
    },
    {
        "id": 15,
        "question": "أنا مفهوم إسلامي، يعني بذل الجهد في سبيل الله، وقد يكون بالقتال أو بالدعوة أو بالعلم. فما أنا؟",
        "answer": "الجهاد",
        "explanation": "الجهاد في الإسلام هو بذل الجهد في سبيل الله، وقد يكون جهاداً بالنفس، أو بالمال، أو باللسان، أو بالقلم.",
        "difficulty": "صعب"
    }
]
